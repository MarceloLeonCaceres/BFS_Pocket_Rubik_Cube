...
def faces_to_list(faces):
    ...
    print()
    # print(f"RubikAbastraction.py faces_to_list(input faces), faces: {faces}")
    face_positions={}
    ...
    # print(f"RubikAbastraction.py faces_to_list(output l): {l}")
    return l
...
def list_to_faces(l):
    ...
    print()
    # print(f"RubikAbastraction.py list_to_faces(input l): {l}")
    f={}
    f["F"]=[0,0,0,0]
    f["B"]=[0,0,0,0]
    f["R"]=[0,0,0,0]
    ...
    # print(f"RubikAbastraction.py list_to_faces(output f): {f}")
    return f
...
def check_rep(faces):
    ...
    print()
    # print(f"RubikAbastraction.py check_rep(faces), faces['F'] {faces['F']}")
    # print(f"RubikAbastraction.py check_rep(faces), faces['B'] {faces['B']}")
    # print(f"RubikAbastraction.py check_rep(faces), faces['U'] {faces['U']}")
    # print(f"RubikAbastraction.py check_rep(faces), faces['D'] {faces['D']}")
    # print(f"RubikAbastraction.py check_rep(faces), faces['L'] {faces['L']}")
    # print(f"RubikAbastraction.py check_rep(faces), faces['R'] {faces['R']}")
    r=0
    g=0
    b=0
    w=0
...
def solve_puzzle(starting_faces):
    ...
    print() 
    print(f"RubikAbstraction.py solve_puzzle: starting_faces {starting_faces}")
    try:
